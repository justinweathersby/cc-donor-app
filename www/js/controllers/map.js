// 'use strict'
 ...
 app.controller('MapCtrl', function($scope,$ionicLoading, $state, $ionicPopup, $stateParams, $http) {
...
$scope.completeOrder = function()
{
  ...
  var url = "http://driver-53731.onmodulus.net/api/delivery";
    var fromArray =  [{"name":item.vendor.name, "phone":item.vendor.phone, "lat": item.vendor.location.latitude, "lng": item.vendor.location.longitude}];
     var toArray =  [{"name":localStorage.getItem('user'), "phone":9049998388, "lat": 651651.6151, "lng": 5161.6161}];
